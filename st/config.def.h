 ...
 */
/* static char *font = "BigBlue_Terminal_437TT Nerd Font :pixelsize=21:antialias=true:autohint=true"; */
/* static char *font2[] = { "SpaceMono Nerd Font :pixelsize=21:antialias=true:autohint=true" }; */
static char *font = "RobotoMono Nerd Font:pixelsize=20:antialias=true:autohint=true";
static char *font2[] = { "RobotoMono Nerd Font:pixelsize=20:antialias=true:autohint=true" };
